...
class AddNewKanbanScreen extends StatefulWidget {
  const AddNewKanbanScreen({super.key});

  @override
  State<AddNewKanbanScreen> createState() => _AddNewKanbanScreenState();
}

class _AddNewKanbanScreenState extends State<AddNewKanbanScreen> {
          ...
          TextButton(
            onPressed: () {
              ...
              if (taskTitleController.text.trim().isEmpty) {
                ...
                kanbanController.addKanbanTask(task: task);
                Get.back();
              }
            },
            child: MyText(
